...
const time2 = moment().tz('Asia/Makasar').format('HH:mm:ss') 
 if(time2 < "23:59:50"){
var ucapanWaktu = 'Belum Tidur Ae lu 🌌'
 }
 if(time2 < "23:59:00"){
var ucapanWaktu = 'Selamat Malam 🌌'
 }
 if(time2 < "19:00:00"){
var ucapanWaktu = 'Selamat Menjelang Malam 🌃'
 }
 if(time2 < "18:00:00"){
var ucapanWaktu = 'Selamat Sore 🌅'
 }
 if(time2 < "15:00:00"){
var ucapanWaktu = 'Selamat Menjelang Sore🏙'
 }
  if(time2 < "1:30:00"){
var ucapanWaktu = 'Selamat Menjelang Siang 🌄'
 }
 if(time2 < "11:00:00"){
...
if (isAdmins) if (!text) throw(bvl)
if (m.key.fromMe) if (!text) throw(bvl)
if (isCreator) if (!text) throw(bvl)
kice = m.sender
...
*Please* @${m.mentionedJid[0].split`@`[0]} *to type accept/reject*`
            ...
            break
	case 'donasi': case 'sedekah': case 'donate': case 'bersedekah': {
...
let buttonMessage = {
image: {url: `https://i.ibb.co/djkXYZx/20220818-225226.jpg`},
jpegThumbnail: log0,
caption: teks,
footer: `${botname}`,
buttons: buttons,
...
title:"TERIMA KASIH SUDAH DONASI",
body: "THANKS YOU", 
thumbnail: fs.readFileSync("XeonMedia/theme/cheemspic.jpg"),
mediaType:1,
mediaUrl: 'https://wa.me/6283160327945',
sourceUrl: "https://wa.me/6283160327945"
}}
}
XeonBotInc.sendMessage(m.chat, buttonMessage, { quoted: m })
          ...
          break
	case 'sc': case 'script': {
teks = `*「 ${global.botname} 𝗕𝗢𝗧」*\n\n𝗖𝗛𝗔𝗧 𝗢𝗪𝗡𝗘𝗥 𝗗𝗜 𝗕𝗔𝗪𝗔𝗛\nhttps://wa.me/6283160327945`
let buttons = [
{buttonId: `owner`, buttonText: {displayText: 'Owner 🌺'}, type: 1}
]
let buttonMessage = {
image: {url: `https://i.ibb.co/XFcPKGr/images-1.jpg`},
jpegThumbnail: log0,
caption: teks,
footer: `${botname}`,
buttons: buttons,
...
XeonBotInc.sendMessage(from, { text : `Hai Kak @${sender.split("@")[0]}, Nih Owner ku 🤗 `, mentions: [sender]}, { quoted: m })
}                
            break
            case 'setmenu': {
            if (!isCreator) throw mess.owner
...
if (!text) throw (`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6283160327945`)
prrkek = q.split("|")[0].replace(/[^0-9]/g, '')+`@s.whatsapp.net`
let ceknya = await XeonBotInc.onWhatsApp(prrkek)
if (ceknya.length == 0) if (!text) throw(`Masukkan Nomor Yang Valid Dan Terdaftar Di WhatsApp!!!`)
prem.push(prrkek)
...
case 'delprem':
if (!isCreator) return m.reply(mess.owner)
if (!args[0]) m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6283160327945`)
...
break
case 'listowner': case 'cekowner':
teks = '*Daftar Owner*\n\n'
for (let ohlx of owner) {
teks += `- ${ohlx}\n`
}
teks += `\n*Total : ${owner.length}*`
XeonBotInc.sendMessage(m.chat, { text: teks.trim() }, 'extendedTextMessage', { quoted: m, contextInfo: { "mentionedJid": prem } })
...
sections: seactiones,
listType: 1}
XeonBotInc.sendMessage(from, listSw, { quoted: m })
}
break
case 'sewaohx':
if ((args[0]) == '1minggu'){
...
XeonBotInc.sendMessage(ownernya,{text:`*❏ ORDER ❏*
...
m.reply(`SEWA BOT ADALAH BOT AKAN MASUK KE GRUP KAMU `)
}
break
case 'premohx':
if ((args[0]) == '1minggu'){
...
m.reply(`Premium Adalah Untuk Membuka Fitur Yang Terkunci\ndan Harus untuk Premium`)
}
break
case 'botohx':
if ((args[0]) == '1minggu'){
...
case 'alive': case 'panel': case 'list': case 'menu': case 'help': case '?': {
            ...
            const latensie = speed() - timestampe
            const xeonezy = `
   Hai Kak @${sender.split("@")[0]} ${ucapanWaktu} ☺         
────「 𝘽𝙊𝙏 𝙄𝙉𝙁𝙊 」────
│𝗦𝗽𝗲𝗲𝗱 𝗕𝗼𝘁 : ${latensie.toFixed(4)} miliseconds
│𝗥𝘂𝗻𝘁𝗶𝗺𝗲 : ${runtime(process.uptime())}
│𝘄𝗵𝗮𝘁𝘀𝗮𝗽𝗽 𝗕𝘆: @${ini_mark.split('@')[0]}
...
│𝗡𝗼𝗺𝗼𝗿 : @${me.split('@')[0]}
│𝗣𝗿𝗲𝗺𝗶𝘂𝗺 : ${isPremium ? '✅' : `❌`}
│𝗟𝗶𝗺𝗶𝘁 : ${isPremium ? '♾Unlimited' : `〽️${db.data.users[m.sender].limit}`}
│
└─「 𝙏𝙄𝙈𝙀 𝙄𝙉𝙁𝙊 」
│𝗝𝗮𝗺 : ${xtime}
│𝗧𝗮𝗻𝗴𝗴𝗮𝗹 : ${xdate}
└────────────┈ ⳹`
            ...
            let buttons = [{ buttonId: 'command', buttonText: { displayText: 'Daftar Menu 📃' }, type: 1 },{ buttonId: 'Sewa', buttonText: { displayText: 'Sewa ✅' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: 'Donasi 😇' }, type: 1 }]
            let buttonMessage = {
...
},
{
	"title": `🗣)ഒ Request Fitur`, "rowId": ".request", "description": "✧ Request Fitur menarik ke BOT", 
							...
							},
							{
								...
								"rows": [
									{
										"title": "⫹🗒️ › 𐐪-〚 All Menu 〛-𐑂",
										"description": "╰► Waduhh. Langsung semuanya (≧▽≦)",
										"rowId": `${prefix}allmenu`
									},
									{
										"title": `⫹👩‍💻 › 𐐪-〚 Owner 〛-𐑂`,
										"description": "╰► Yg bukan developer gausah nge klik fitur ini !",
										"rowId": `${prefix}ownermenu`
										},
									{
										"title": `⫹🦄 › 𐐪-〚 Group 〛-𐑂`,
									    "description": "╰► Menu settingan buat group mu kak -𐑂",
										"rowId": `${prefix}groupmenu`
										},
										{
										"title": `⫹ 🎨 › 𐐪-〚 Maker Menu 〛-𐑂`,
...
const buttons = [
  {buttonId: 'script', buttonText: {displayText: 'Sewa 🔖'}, type: 1},
